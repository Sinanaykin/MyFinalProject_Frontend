...
export class ProductAddComponent implements OnInit {
  ...
  add(){
    if (this.productAddForm.valid) {//Eğer validation lar uyuyorsa
     ...
     this.productService.add(productModel).subscribe(response=>{ //productService deki Add metoduna productModel'i gönderiyoruz ve asekronluğa uysun diye mesajı subscribe içinde vericez.Başarılı ise bu çalışır
